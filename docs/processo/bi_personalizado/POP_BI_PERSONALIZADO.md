...
O desenvolvimento segue o Blueprint aprovado pelo cliente. O caminho padrão é Claude Code — ver `docs/processo/fases/fase3_desenvolvimento.md` para o fluxo completo com referências à pasta `docs/build/arquitetura/`.
